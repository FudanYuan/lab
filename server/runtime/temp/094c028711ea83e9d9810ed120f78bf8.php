		...
		<div class="list-search">
			<form action="" class="form-inline" method="get" >
			  ...
			  <div class="form-group">
				...
				<input name="author" class="form-control" style="width:200px" value="<?php echo isset($cond['author']) ? $cond['author'] :  ''; ?>" />
			  </div>
		  ...
		  <tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$model): ?>
				<tr>
					...
					<td><?php if($model['publishtime']): ?><?php echo date("Y-m-d H:i",$model['publishtime']); endif; ?></td>
					<td><?php echo $model['count_view']; ?></td>
					<td>
						<?php if(authority('News_top')): ?>
						...
						<?php endif; if(authority('News_recomm')): if($model['isrecommend']): ?>
						...
						<?php endif; endif; if(authority('News_edit')): ?>
						<a href="__PRO_PATH__/News/edit?id=<?php echo $model['id']; ?>">编辑</a>
						<?php endif; ?>
					</td>
				</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
