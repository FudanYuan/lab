		  ...
		  <tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$model): ?>
				<tr>
					...
					<td>
						<?php if(authority('Role_edit')): ?>
						<a href="__PRO_PATH__/UserAdmin/roleedit?id=<?php echo $model['id']; ?>">编辑</a>
						<?php endif; ?>
					</td>
				</tr>
...
<script>
	...
	$('#lab-nav6-sub3').addClass('active');
	popupList({
		create:'__PRO_PATH__/UserAdmin/rolecreate',
