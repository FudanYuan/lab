...
<div class="main-container">
	<div class="padding-md">
		...
		<div class="list-btns">
			<?php if(authority('ProMember_add')): ?>
			<button type="button" class="btn btn-success" id="addItem">新建</button>
			<?php endif; if(authority('ProMember_del')): ?>
		...
		<table class="table table-hover" style="background:#fff;">
			...
			<tr>
				...
				<td>
					...
					<a href="__PRO_PATH__/Member/last_edit?id=<?php echo $model['id']; ?>">编辑</a>
					<?php endif; ?>
				</td>
			</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
	...
	popupList({
		create:'__PRO_PATH__/Member/last_create',
