<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Banner/index.html";i:1503047102;s:73:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/top.html";i:1503214051;s:80:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/popup_warn.html";i:1503219129;s:86:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/popup_cancel_top.html";i:1494927125;s:76:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/bottom.html";i:1502885165;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
		...
		<div class="list-search">
			<form action="" class="form-inline" method="get" >
			  <div class="form-group">
			    <label for="select-pos">位置：</label>
			    <select name="position" class="form-control" style="width:100px" id="select-pos">
			  ...
			  <div class="form-group">
				...
				<input id="select-title" name="title" class="form-control" style="width:200px" value="<?php echo isset($cond['title']) ? $cond['title'] :  ''; ?>" />
			  </div>
			  <button type="submit" class="btn btn-default">查询</button>
			  <script>
			  	$('#select-pos').val('<?php echo isset($cond['position']) ? $cond['position'] :  -1; ?>');
			  </script>
			</form>
		</div>
		<div class="list-btns">
			<?php if(authority('Banner_del')): ?>
			<button type="button" class="btn btn-default" id="removeItem">取消置顶</button>
			<?php endif; ?>
		</div>
		  ...
		  <tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$model): ?>
				<tr>
					...
					<td><?php echo date("Y-m-d",$model['begintime']); ?></td>
					<td><?php echo date("Y-m-d",$model['endtime']); ?></td>
				</tr>
...
<script>
	$('#lab-nav2').addClass('active');
	popuCancel({
		remove:'__PRO_PATH__/Banner/canceltop'
	});
</script>
<footer class="footer">
