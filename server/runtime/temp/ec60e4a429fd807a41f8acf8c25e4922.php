<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:72:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/News/edit.html";i:1509727453;s:73:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/top.html";i:1503214051;s:80:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/popup_warn.html";i:1503219129;s:78:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/calendar.html";i:1502883587;s:76:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/upload.html";i:1502937049;s:80:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/popup_edit.html";i:1494927125;s:76:"/Applications/XAMPP/xamppfiles/htdocs/lab/server/app/view/Common/bottom.html";i:1502885165;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-container">
    <div class="padding-md">
        <ul class="breadcrumb">
            ...
            <li><span class="primary-font"><i class="icon-home"></i></span><a href="__PRO_PATH__/News/index">大赛新闻</a></li>
            <li>编辑</li>
        </ul>
        <div class="form-wrapper">
            <form class="form-horizontal" method="post" id="main-form">
                <input type="hidden" name="id" value="<?php echo $data['id']; ?>"/>
                <input type="hidden" name="ispublish" value="<?php echo $data['ispublish']; ?>"/>
                ...
                <div class="form-group <?php if(!empty($errors['author'])) echo  'has-error'; ?>">
                    ...
                    <div class="col-sm-4">
                        ...
                        <span class="help-block"><?php echo isset($errors['author']) ? $errors['author'] : ''; ?></span>
                    </div>
                </div>
                <div class="form-group <?php if(!empty($errors['digest'])) echo  'has-error'; ?>">
                    ...
                    <div class="col-sm-8">
                        <textarea name="digest" class="form-control" id="form-digest"
                                  rows="3"><?php echo isset($data['digest']) ? $data['digest'] : ''; ?></textarea>
                ...
                <div class="form-group <?php if(!empty($errors['regular_publishtime'])) echo  'has-error'; ?>">
                    ...
                    <div class="col-sm-4">
                        <input name="regular_publishtime_str" data-enable-time=true data-time_24hr=true
                               class="form-control flatpickr" value="<?php echo isset($data['regular_publishtime_str']) ? $data['regular_publishtime_str'] : ''; ?>">
                        <span class="help-block"><?php echo isset($errors['regular_publishtime']) ? $errors['regular_publishtime'] :  ''; ?></span>
                    </div>
                </div>
...
function popupEdit(config){
	...
	$('.confirm-do').on('click', function(){
		...
		$.get(config.remove, {ids: config.id}, function(res){
			if(res['code'] == 1){
