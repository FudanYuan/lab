...
function dTree(objName) {
	...
	this.icon = {
		root				: '/server/public/js/dtree/img/base.gif',
		folder			: '/server/public/js/dtree/img/folder.gif',
		folderOpen	: '/server/public/js/dtree/img/folderopen.gif',
		node				: '/server/public/js/dtree/img/page.gif',
		empty				: '/server/public/js/dtree/img/empty.gif',
		line				: '/server/public/js/dtree/img/line.gif',
		join				: '/server/public/js/dtree/img/join.gif',
		joinBottom	: '/server/public/js/dtree/img/joinbottom.gif',
		plus				: '/public/js/dtree/img/plus.gif',
		plusBottom	: '/server/public/js/dtree/img/plusbottom.gif',
		minus				: '/server/public/js/dtree/img/minus.gif',
		minusBottom	: '/server/public/js/dtree/img/minusbottom.gif',
		nlPlus			: '/server/public/js/dtree/img/nolines_plus.gif',
		nlMinus			: '/server/public/js/dtree/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
