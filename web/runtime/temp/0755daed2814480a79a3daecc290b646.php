<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/Applications/XAMPP/xamppfiles/htdocs/lab/web/app/view/Member/tutor.html";i:1515680462;s:70:"/Applications/XAMPP/xamppfiles/htdocs/lab/web/app/view/Common/top.html";i:1515684782;s:73:"/Applications/XAMPP/xamppfiles/htdocs/lab/web/app/view/Common/bottom.html";i:1514088785;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div class="main">
        <div class="con">
            <div class="c-top">
                ...
                <a href="?" class="<?php if(empty($curTagid) || ($curTagid instanceof \think\Collection && $curTagid->isEmpty())): ?>cur<?php endif; ?>" hidden>全部</a>
                <?php if(is_array($tags) || $tags instanceof \think\Collection): if( count($tags)==0 ) : echo "" ;else: foreach($tags as $key=>$tag): if($tag['title'] != '实验室'): ?>
                <a href="?tagid=<?php echo $tag['id']; ?>" class="<?php if($curTagid==$tag['id']): ?>cur<?php endif; ?>" hidden><?php echo $tag['title']; ?></a>
            ...
            <p style="margin: 30px 30px; padding-bottom:5px; font-weight: bold; border-bottom: 1px dashed #fcb130;" hidden><?php echo $tag['title']; ?></p>
            <?php endif; ?>
            <ul class="list clearFix">
                <?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$model): if($tag['id'] == $model['tagid']): ?>
                <li>
                    <a href="<?php if(empty($model['url']) || ($model['url'] instanceof \think\Collection && $model['url']->isEmpty())): ?>__PRO_PATH__/Member/info?id=<?php echo $model['id']; else: ?><?php echo $model['url']; endif; ?>">
                        ...
                        <p style="margin: 5px; width: 90px; height: 200px; overflow: hidden">
